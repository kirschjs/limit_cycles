...
C
      CHARACTER*80 QUAOU,DRQUAOU,INFILE, OUTPUTout1, OUTPUTout2

      call getarg(1,QUAOU)

      call getarg(2,DRQUAOU)

      call getarg(3,INFILE)
      OPEN(UNIT=5,FILE=INFILE,STATUS='OLD')
      
      call getarg(4,OUTPUTout1)
      OPEN(UNIT=6,FILE=OUTPUTout1)
      
      call getarg(5,OUTPUTout2)
...
C
      ...
      IDREI=0
      IF(NBAND1.GT.0)  THEN
          OPEN(UNIT=10,FILE=QUAOU,STATUS='OLD',FORM='UNFORMATTED')
          IZWEI=1
          endif
      IDREI=0
      IF(ABS(NBAND1).GT.10)  THEN
          OPEN(UNIT=11,FILE=DRQUAOU,STATUS='OLD',FORM='UNFORMATTED')
          IDREI=1
          endif
...
<<<<<<< HEAD:src_nucl/DR2END_AK_pop.f
      write(nout,*)'NORM, HAMILTONIAN MATRICES WRITTEN.'
=======
C      write(nout,*)'NORM, HAMILTONIAN MATRICES WRITTEN.'
>>>>>>> 5622f4468f288a12760ac50af7dec4e2add31097:src_nucl/DR2END_v18-uix_pop.f
      STOP
C     LAPACK-AUFRUF
      ITYPE=1
      JOBZ='V'
