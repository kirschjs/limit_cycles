...
lec_list_c = {  #d0GS  TNI-UIX  ZENTRAL    NNN        PROJ           d0ES
    '2.00':
...
# lec_list_d  : spin-dependent LO pionless interaction: 2 2-body LECs (deuteron, a(1S0)=-23fm), 1 3-body LEC (triton)
# lec_list_def: spin-independent (SU(4) symmetric) LO pionless: 1 2-body LEC (deuteron), 1 3-body LEC (triton)
lec_set = lec_list_def  # lec_list_d  #
