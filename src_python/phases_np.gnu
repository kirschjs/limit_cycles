...
plot 'a_ratio_4.0.dat' u ($1):($2) lc rgb  '#21618C' lw 1.5 ps 1.5 pt 7 w l t 'np ${}^3S_1$',\
	'a_ratio_4.0.dat' u ($1):($3) lc rgb  '#21618C' lw 1.5 ps 0.5 pt 1 w lp t 'np ${}^1S_0$',\
     'a_ratio_4.0.dat' u ($1):($4) lc rgb  '#A93226' lw 1.5 ps 1.5 pt 7 w l t 'd-d',\
     'a_ratio_4.0.dat' u ($1):($5) lc rgb  '#A93226' lw 1.5 ps 0.5 pt 8 w lp t 'dq-dq',\
     'a_ratio_4.0.dat' u ($1):($6) lc rgb  '#186A3B' lw 1.5 ps 1.5 pt 7 w l t 't-p',\
     'a_ratio_4.0.dat' u ($1):($7) lc rgb  '#186A3B' lw 1.5 ps 0.5 pt 8 w lp t 'he3-n'
