...
#            inputsphase_nn(e0=0.05,nzen=2,eps=0.1,bet=4.1,d0=0.05,nzrw=400,frr=0.02,rhg=8.0,rhf=1.0)
#            os.system(bin_dir + 'S-POLE_CIB.exe')
#            read_phase(phases,np_dir,1)
#            if ch==3:
#                a = appC(phases[-1][0]*pi/180.0,sqrt(mn[mpii]*phases[0][0]))
#                #print a.real,afit,ch
#            else:
#                a = anp(phases[-1][0]*pi/180.0,sqrt(mn[mpii]*phases[0][0]))
