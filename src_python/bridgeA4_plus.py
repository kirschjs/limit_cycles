...
#     calculate_and_plot_cross_sections(
#     input_pattern='4_ph_%d_%s_%s.txt' % (neps, lam, lecstring),
#     output_pattern='4bdy_cross_section_',  # consistent naming convention
#     J=0,
#     s1=0,
#     s2=1/2,
#     output_pdf='4bdy_cross_sections_%d_%s_%s.pdf' % (neps, lam, lecstring)
# )
...
os.system('pdfjam --quiet --outfile %s --nup 2x%d DcoffHist_*.pdf' %
          ('4bdy_Dcoff-mosaic_%s_%s.pdf' %
           (lam, lecstring), int(np.ceil(epsNBR / 2))))
os.system('pdfjam --quiet --outfile %s --nup 2x%d 4bdy_cross_sections_*.pdf' %
          ('4bdy_cross_sections-mosaic_%s_%s.pdf' % 
            (lam, lecstring), int(np.ceil(epsNBR / 2))))
...
os.system('rm 4bdy_cross_sections_*.pdf')
